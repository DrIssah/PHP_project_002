...
$query1="SELECT * FROM usermessages WHERE Target='Admin'";
...
<ul>
	...
	<ul>
	<li><a href="checkFeeBalance.php" >Students With Balances</a></li>
	<li><a href="FeeStatements.php" >Student Ledger</a></li>
	<li><a href="payfees.php">Pay School Fees</a></li>
	</ul>
	</li>
...
<legend style="text-align:right">Messages</legend>
...
$UserName=$array1['UserId'];

print ' 
<div id="mesage">
<fieldset>
<legend>Message From Id-'.$UserName.'
